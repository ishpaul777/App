...
export default {
    ...
    SETTINGS_PERSONAL_DETAILS_DATE_OF_BIRTH_YEAR_PICKER: {
        route: 'settings/profile/personal-details/date-of-birth/year',
        getRoute: (year: string, backTo?: string) => getUrlWithBackToParam(`settings/profile/personal-details/date-of-birth/year?year=${year}`, backTo),
    },
