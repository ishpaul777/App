...
const MoneyRequestModalStackNavigator = createModalStackNavigator({
    ...
    Money_Request_Date_YearPicker: () => require('../../../pages/iou/MoneyRequestDateYearPickerPage').default,
...
const SettingsModalStackNavigator = createModalStackNavigator({
    ...
    Settings_PersonalDetails_DateOfBirth_YearPicker: () => require('../../../pages/settings/Profile/PersonalDetails/YearPickerPage').default,
